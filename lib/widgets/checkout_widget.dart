...
//             final prices = _calculatePrices(state.items, couponState);
//             return Container(
...
//                         isDiscount: true),
//                   _buildCouponSection(prices.subtotal),
//                   // If coupon is applied, show coupon discount
...
//                 children: [
//                   Text(
//                     'Coupon Applied (${state.coupon.couponCode})',
//                     style: styling(),
//                   ),
//                   IconButton(
...
//               ),
//               _buildPriceRow(
//                 'Coupon Discount (${state.coupon.discount}%)',
...
//             ),
//             TextButton.icon(
//               onPressed: () => _showAvailableCoupons(context, subtotal),
//               icon: Icon(Icons.local_offer),
//               label: Text('View Available Coupons'),
//             ),
...
//   void _showAvailableCoupons(BuildContext context, double subtotal) {
//     context.read<CouponBloc>().add(LoadAvailableCouponsEvent());

//     showModalBottomSheet(
//       context: context,
//       builder: (context) => BlocBuilder<CouponBloc, CouponState>(
//         builder: (context, state) {
...
class EnhancedOrderSummary extends StatelessWidget {
  ...
  Widget _buildCouponSection(
    ...
    // Get cart items from the CartBloc
                  ...
                  if (couponController.text.isNotEmpty) {
                    context.read<CouponBloc>().add(
                          ApplyCouponEvent(
                            couponCode: couponController.text,
                            cartItems:
                                cartItems, // Pass cart items instead of total
                          ),
                        );
                  }
                },
